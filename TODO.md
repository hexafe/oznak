...
|---|---|---|---|---|---|
| BL-001 | Polish the package-native CLI/TUI operator experience | P1 | Phase 3 — CLI and TUI productization | CLI and TUI are now the primary standalone surfaces; remaining work is cancellation ergonomics and advanced diagnostics drill-down. | `src/oznak/cli.py`, `src/oznak/tui.py`, search: `tests/test_package_tui.py` |
